...
const Navigation = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-black/95 shadow-lg backdrop-blur-sm' : 'bg-black/90'}`}>
      <div className="container flex justify-between items-center h-20 px-4 md:px-8">
        {/* Logo */}
        <div className="h-10">
          <Link to="/" className="inline-block">
            <svg viewBox="0 0 63 20" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMin meet" width="100%" height="100%" className="text-white transition-transform hover:scale-105">
        ...
        <nav className="hidden md:flex">
          <ul className="flex gap-8">
            <li>
              <Link to="/premium" className="text-white font-bold text-base py-7 hover:text-[#1ED760] transition-all duration-200 relative hover:after:transform hover:after:scale-x-100 after:content-[''] after:absolute after:bottom-5 after:left-1/2 after:-translate-x-1/2 after:h-0.5 after:w-full after:transform after:scale-x-0 after:bg-[#1ED760] after:transition-transform after:duration-250">
                Premium
              </Link>
            </li>
            <li>
              <Link to="/support" className="text-white font-bold text-base py-7 hover:text-[#1ED760] transition-all duration-200 relative hover:after:transform hover:after:scale-x-100 after:content-[''] after:absolute after:bottom-5 after:left-1/2 after:-translate-x-1/2 after:h-0.5 after:w-full after:transform after:scale-x-0 after:bg-[#1ED760] after:transition-transform after:duration-250">
                Support
              </Link>
            </li>
            <li>
              <Link to="/download" className="text-white font-bold text-base py-7 hover:text-[#1ED760] transition-all duration-200 relative hover:after:transform hover:after:scale-x-100 after:content-[''] after:absolute after:bottom-5 after:left-1/2 after:-translate-x-1/2 after:h-0.5 after:w-full after:transform after:scale-x-0 after:bg-[#1ED760] after:transition-transform after:duration-250">
                Download
              </Link>
            </li>
            <li>
              <Link to="/signup" className="text-white font-bold text-base py-7 hover:text-[#1ED760] transition-all duration-200 relative hover:after:transform hover:after:scale-x-100 after:content-[''] after:absolute after:bottom-5 after:left-1/2 after:-translate-x-1/2 after:h-0.5 after:w-full after:transform after:scale-x-0 after:bg-[#1ED760] after:transition-transform after:duration-250">
                Sign up
              </Link>
            </li>
            <li>
              <Link to="/login" className="text-white font-bold text-base py-7 hover:text-[#1ED760] transition-all duration-200 relative hover:after:transform hover:after:scale-x-100 after:content-[''] after:absolute after:bottom-5 after:left-1/2 after:-translate-x-1/2 after:h-0.5 after:w-full after:transform after:scale-x-0 after:bg-[#1ED760] after:transition-transform after:duration-250">
                Log in
              </Link>
            </li>
          </ul>
        ...
        {/* Mobile Menu Button */}
        <button 
          className="md:hidden text-white text-2xl p-2 hover:text-[#1ED760] transition-colors" 
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className="md:hidden absolute top-20 left-0 w-full bg-black/95 backdrop-blur-sm py-4 shadow-lg z-50 animate-fade-in">
            <ul className="flex flex-col items-center gap-4">
              <li>
                <Link to="/premium" className="text-white font-bold text-base py-2 px-4 block hover:text-[#1ED760] transition-colors" onClick={() => setMobileMenuOpen(false)}>
                  Premium
                </Link>
              </li>
              <li>
                <Link to="/support" className="text-white font-bold text-base py-2 px-4 block hover:text-[#1ED760] transition-colors" onClick={() => setMobileMenuOpen(false)}>
                  Support
                </Link>
              </li>
              <li>
                <Link to="/download" className="text-white font-bold text-base py-2 px-4 block hover:text-[#1ED760] transition-colors" onClick={() => setMobileMenuOpen(false)}>
                  Download
                </Link>
              </li>
              <li>
                <Link to="/signup" className="text-white font-bold text-base py-2 px-4 block hover:text-[#1ED760] transition-colors" onClick={() => setMobileMenuOpen(false)}>
                  Sign up
                </Link>
              </li>
              <li>
                <Link to="/login" className="text-white font-bold text-base py-2 px-4 block hover:text-[#1ED760] transition-colors" onClick={() => setMobileMenuOpen(false)}>
                  Log in
                </Link>
              </li>
            </ul>
