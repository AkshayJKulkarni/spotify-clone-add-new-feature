      ...
      <div className="container max-w-md mx-auto px-4">
        ...
        <div className="bg-[#121212] p-8 rounded-lg">
          ...
          <div className="mt-6 text-center">
            <Link to="/forgot-password" className="text-white hover:underline">Forgot your password?</Link>
          </div>
          
          <div className="mt-8 text-center">
            <p className="text-gray-400">Don't have an account?</p>
            <Link to="/signup" className="text-white hover:underline mt-2 inline-block">Sign up for Spotify</Link>
          </div>
        </div>
      </div>
    </div>
