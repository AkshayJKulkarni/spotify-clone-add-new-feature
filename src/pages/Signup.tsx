...
const Signup = () => {
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    toast.success('Sign up form submitted! (This is a demo)');
  };
    ...
    <div className="pt-24 min-h-screen bg-black">
      <div className="container max-w-md mx-auto px-4">
        <div className="flex justify-center mb-8">
          <svg viewBox="0 0 63 20" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMin meet" width="120" height="40" className="text-white">
        ...
        <div className="bg-[#121212] p-8 rounded-lg">
          <h1 className="text-3xl font-bold text-white mb-6 text-center">Sign up for free</h1>
          <p className="text-white text-center mb-8">Create a free account to get started with Spotify</p>
          
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="email" className="block text-white mb-2">What's your email?</label>
              <input 
                type="email" 
                id="email"
                className="w-full p-3 rounded-md bg-[#333] text-white focus:outline-none focus:ring-2 focus:ring-[#1ED760]"
                placeholder="Enter your email"
              />
            </div>
            
            <div>
              <label htmlFor="password" className="block text-white mb-2">Create a password</label>
              <input 
                type="password" 
                id="password"
                className="w-full p-3 rounded-md bg-[#333] text-white focus:outline-none focus:ring-2 focus:ring-[#1ED760]"
            ...
            <div>
              <label htmlFor="name" className="block text-white mb-2">What should we call you?</label>
              <input 
                type="text" 
                id="name"
                className="w-full p-3 rounded-md bg-[#333] text-white focus:outline-none focus:ring-2 focus:ring-[#1ED760]"
            ...
            <Button 
              type="submit"
              className="w-full bg-[#1ED760] text-black hover:bg-[#1FDF64] hover:scale-105 transition-transform font-bold text-base py-6"
            >
              Sign Up
            </Button>
          </form>
          ...
          <div className="mt-8 text-center">
            ...
            <Link to="/login" className="text-white hover:underline mt-2 inline-block">Log in</Link>
          </div>
        </div>
      </div>
    </div>
